...
const features = [
  ...
  },
  {
    ...
    text:
      "若你有興趣參與今年 SITCON Hackathon 2024，可以先填寫事前調查表單，讓我們了解你對活動的期待與想法。若比賽開始正式報名，我們也會在第一時間提供報名資訊！",
    icon: <CreateIcon style={{ fontSize: iconSize }} />,
    mdDelay: "400",
    smDelay: "200",
    data: {link: ['SITCON Hackathon 2024 事前調查表單', 'https://forms.gle/bqTfygXkGnJnaaDCA']}
  },
  {
    color: "#304FFE",
    headline: "關於 SITCON",
